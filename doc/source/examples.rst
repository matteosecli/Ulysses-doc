...
.. code-block:: bash
   :caption: Serial job asking for 20 threads, 20 GB of memory and 10 hours on either ``regular1`` or ``regular2``. The output and error filenames are in TORUQE style.
   :linenos:
...
.. code-block:: bash
   :caption: Parallel job asking for 16 MPI tasks, each with 8 threads and 7.92 GB of memory for a total of 12 hours on ``regular2``. The output and error filenames are in TORUQE style.
   :linenos:
...
.. code-block:: bash
   :caption: Parallel job asking for 16 MPI tasks distributed among 2 nodes, each task with 8 threads and 7.92 GB of memory for a total of 12 hours on ``regular2``. The output and error filenames are in TORUQE style.
   :linenos:
